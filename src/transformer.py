...
class CTransformer(nn.Module):
    def __init__(self, k, heads, depth, max_seq_length, vocab_size, num_classes): 
        ...
        self.token_emb = nn.Embedding(vocab_size, k)  #look up table for word embedding: (vocab_size x k)
        self.position_em = nn.Embedding(max_seq_length, k) # look up table for positions
